...
contenedorPrincipal.id="contenedorPLP";
...
for(var i = 0; i< obj.RetailItemCommList.RetailItemComm.length; i++){
  ...
  document.getElementById("contenedorPLP").appendChild(divArticle);
...
/*BREAKS*/
var objBreaks = JSON.parse(respuesta);
var posBreak = [2,4,6];
var longBreaks = [1,2,2];
var cont1 = "<p class=''>Aquí va un texto que es un breakout, muy triste pero muy feliz, se podría meter cualquier cosa</p>";
var cont2 = "<p>Aquí va un texto que es un breakout, muy triste pero muy feliz, se podría meter cualquier cosa</p>";
var cont3 = "<p><img src='' style=''>Aquí va un texto que es un breakout, muy triste pero muy feliz, se podría meter cualquier cosa</p>";
var contBreak = [cont1,cont2,cont3];

function addBreaksOuts(posBreak, contBreak,longBreaks){
  for(var l = posBreak.length-1; l>=0; l--){
    var breakLookFor = document.getElementsByClassName("divArticulo")[posBreak[l]];
    breakLookFor = breakLookFor.id;
    var breakToAdd = document.createElement("div");
    if(longBreaks[l]==1){
      breakToAdd.classList.add("col-xs-6");
      breakToAdd.classList.add("col-sm-6");
      breakToAdd.classList.add("col-md-3");
      breakToAdd.classList.add("col-lg-3");
    }
    else if(longBreaks[l]==2){
      breakToAdd.classList.add("col-xs-12");
      breakToAdd.classList.add("col-sm-12");
      breakToAdd.classList.add("col-md-6");
      breakToAdd.classList.add("col-lg-6");
    }
    breakToAdd.classList.add("divBreak");
    var idBreak =  "break_"+l;
    breakToAdd.id = idBreak;
    document.getElementById("contenedorPLP").insertBefore(breakToAdd,document.getElementById(breakLookFor));
    document.getElementById(idBreak).innerHTML = contBreak[l];
  }
}

addBreaksOuts(posBreak,contBreak,longBreaks);
/*BREAKS*/